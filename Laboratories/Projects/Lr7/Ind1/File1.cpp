...
cout<<"Введенное число :"<<strpreobraz;
	...
	char s;
	int t=0;
	cout<<"\n\n\nРешение без массивов"<<endl;
	cout<<"Введите число в девятиричной системе: ";
	while(s=getchar(), s!='\n');
	...
	cout<<"В десятичной системе :"<<t<<endl;
	cout<< "В двенадцатиричной системе :";
	if(t==0) cout<<0;
	int tmp=1;
	while(tmp<=t)
		tmp=tmp*q;
